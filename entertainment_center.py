...
#   define a list of movies, open the "Fresh Tomatoes" web site to view list and trailers.
...
movies = [
  ...
  media.Movie("Eternal Sunshine of the Spotless Mind",
